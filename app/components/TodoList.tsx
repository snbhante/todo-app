...
export default function TodoList() {
  ...
  return (
    <section className="dashboard-panel panel mx-auto w-full max-w-5xl">
      <div className="dashboard-header"><div><p className="eyebrow">Your command center</p><h2 className="dashboard-title">Good to see you.</h2><p className="dashboard-subtitle">A clear next step makes the whole day lighter.</p></div><div className="dashboard-actions"><Link href="/profile" className="button-quiet">Profile</Link><button onClick={() => auth.signOut()} className="button-quiet">Log out</button></div></div>
